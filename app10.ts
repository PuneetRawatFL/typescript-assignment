...
let userProfilesAsCasting: user[] = JSON.parse(jsonData) as user[]; //as type assertion
let userProfilesAngleCasting: user[] = <user[]>JSON.parse(jsonData); //angle bracket type assertion
