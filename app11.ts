...
class bankAccount {
    ...
    public static bankName: string = "Axis Bank Mansarovar";
    public static bankIFSC: string = "AXIS000001232";
    constructor(
    ...
    //deposit method
    public depositAmount(a: number) {
        this._balance += a;
        console.log("Updated balance:", this._balance);
    }
    //withdraw method
    public withdrawAmount(a: number) {
...
class SavingsAccount extends bankAccount {
    ...
    addInterest() {
        ...
        this._balance += int;
        console.log(
            `Interest applied: ${this.interest} Updated _balance: ${this._balance}`
        );
    }
}
...
class CheckingAccount extends bankAccount {
    ...
    public withdraw(amount: number): void {
        if (amount > 0 && this._balance + this.overdraftLimit >= amount) {
            ...
            console.log(
                `Withdrawn: $${amount}. New Balance: $${this._balance}`
            );
        } else {
...
console.log(
    `Savings Account Holder Name: ${savingsAccount.getAccountHolder()}`
);
...
console.log(
    `Checking Account Holder Name: ${checkingAccount.getAccountHolder()}`
);
